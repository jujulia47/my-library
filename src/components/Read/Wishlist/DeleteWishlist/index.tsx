...
export default function DeleteWishlistBtn({id}: {id: number}) {
  ...
  return (
    <>
      ...
      >
      {isDeleting ? (
        <svg className="animate-spin h-5 w-5 text-[#B85C5A]" viewBox="0 0 24 24">
      ...
      {showPopUp && (
        <ConfirmationPopUp
          message="Certeza que deseja excluir este item da wishlist?"

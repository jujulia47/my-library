                    ...
                    <div className="library-card p-8 bg-gradient-to-br from-amber-50 to-amber-100 rounded-xl border-2 border-amber-200 shadow-md hover:shadow-xl hover:border-amber-300 transition-all duration-300">
                      ...
                      <div className="mb-8">
                        <div className="bg-gradient-to-br from-amber-50 to-amber-100 rounded-xl border-2 border-amber-100 shadow-sm flex-col">
                          {booksInfos.length > 0 && (
                            <h3 className="p-5 text-xl font-bold text-amber-900 mb-4 flex items-center">
                              <svg
                              ...
                              <p className="text-xl font-bold bg-gradient-to-r from-amber-800 to-amber-600 bg-clip-text text-transparent">Livros</p>
                            </h3>
                          )}
                          ...
                          {booksInfos.length > 0 && (
                            <div className="space-y-4 mb-8 p-5">
                              <div className="flex items-center justify-between mb-4">
                                <h4 className="text-base font-semibold text-amber-900 flex items-center">
                                  <div className="p-2 bg-amber-200/50 rounded-lg mr-3">
                                    <svg
                                      className="w-5 h-5 text-amber-700"
                                      fill="none"
                              ...
                              <div className="space-y-2">
                                <div className="flex items-center justify-between text-sm font-medium text-amber-800">
                                  <span className="flex items-center">
                                    <span className="bg-amber-200/70 px-2 py-1 rounded-md mr-2">
                                      {
                                        collection[0].collection_book.filter(
                                          (b) => b.book?.status === "finish"
                                        ).length
                        ...
                        {seriesInfos.length > 0 && (
                          <div className="mt-8">
                            <h3 className="text-xl font-bold text-amber-900 mb-4 flex items-center">
                              ...
                              <p className="text-xl font-bold bg-gradient-to-r from-amber-800 to-amber-600 bg-clip-text text-transparent">Séries</p>
                            </h3>

                            {/* Estatísticas de Séries */}
                            <div className="grid grid-cols-2 gap-4 mb-4">
                              <div className="bg-gradient-to-br from-amber-50 to-amber-100 p-5 rounded-xl border-2 border-amber-100 shadow-sm hover:shadow-md transition-all duration-300">
                                <div className="flex items-center text-amber-700 mb-2">
                                  <div className="p-2 bg-amber-200/50 rounded-lg mr-3">
                                    <svg
                                      className="w-5 h-5 text-amber-700"
                                ...
                                <div className="text-3xl font-bold bg-gradient-to-r from-amber-800 to-amber-600 bg-clip-text text-transparent pl-11">
                            ...
                            <div className="space-y-4 mb-8 p-5 bg-gradient-to-br from-amber-50 to-amber-100 rounded-xl border-2 border-amber-100 shadow-sm">
                              <div className="flex items-center justify-between mb-4">
                                <h4 className="text-base font-semibold text-amber-900 flex items-center">
                                  <div className="p-2 bg-amber-200/50 rounded-lg mr-3">
                                    <svg
                              ...
                              <div className="space-y-2">
                                ...
                                <div className="relative pt-1">
                                  <div className="overflow-hidden h-3 mb-2 text-xs flex rounded-full bg-amber-200/50">
                                    <div
                                      style={{
                                        width: `${collection[0].collection_serie.length > 0
                                          ? Math.round(
                                            (collection[0].collection_serie.filter(
                                              (s) => s.serie?.status === "finish"
                                            ).length /
                        ...
                        {wishlistInfos.length > 0 && (
                          <div className="mt-8">
                            ...
                            <div className="bg-gradient-to-br from-amber-50 to-amber-100 p-5 rounded-xl border-2 border-amber-100 shadow-sm">
                              <p className="text-3xl font-bold bg-gradient-to-r from-amber-700 to-amber-500 bg-clip-text text-transparent">{wishlistInfos.length}</p>
                              <p className="text-sm font-medium text-amber-700 mt-1">Itens na lista de desejos</p>
                            </div>
                          </div>
                        )}
                        ...
                        <div className="space-y-4 p-6 bg-gradient-to-br from-amber-50 to-amber-100 rounded-xl border-2 border-amber-100 shadow-sm hover:shadow-md transition-all duration-300">
                          <div className="flex items-center justify-between">
                            <h4 className="text-lg font-semibold text-amber-900 flex items-center">
                              <div className="p-2.5 bg-amber-200/60 rounded-xl mr-3 shadow-sm">
                                <svg
                              ...
                              {collection[0].init_date && (
                                <div className="relative pl-6 group">
                                  ...
                                  <div className="text-base font-semibold text-amber-900 flex items-center">
                                    <span>{formatDate(collection[0].init_date)}</span>
                                  </div>
                                </div>
                              )}
                                ...
                                <div className="relative pl-6 group">
                                  ...
                                  {collection[0].init_date && (
                                    <div className="text-xs font-medium text-amber-700 bg-amber-100/50 px-2.5 py-1 rounded-full inline-flex items-center">
                                      ...
                                      {calculateDuration(collection[0].init_date, collection[0].finish_date)}
                                    </div>
                                  )}
                                </div>
                              )}
                          ...
                          <div className="flex gap-6 overflow-y-auto custom-scrollbar">
                            {seriesInfos.map((serie) => (
                              ...
                              >
                                ...
                                <div className="absolute top-0 right-0 w-0 h-0 border-l-[40px] border-l-transparent border-t-[40px] border-t-amber-300/30"></div>

                                <div className="w-full h-full flex flex-col justify-between">
                                  <div className="text-center relative z-10">
                                    {/* Series title with gradient text */}
                                    <p className="text-lg font-semibold bg-gradient-to-r from-amber-800 to-amber-600 bg-clip-text text-transparent line-clamp-2 leading-tight mb-2">
                                      {serie.serie_name}
                                    </p>
                                    ...
                                    {serie.qty_volumes && (
                                      <p className="text-sm font-medium text-amber-700 mb-3">
                                        {serie.qty_volumes} volume{serie.qty_volumes > 1 ? 's' : ''}
                                      </p>
                                    )}
                                  </div>
                                  ...
                                  <div className="relative z-10">
                                    ...
                                    {serie.status && (
                                      <div className="w-full flex justify-center">
                                        <span
                                          className={clsx(
                                            "inline-block px-3 py-1 rounded-full text-xs font-semibold align-middle font-serif text-amber-50 capitalize shadow-sm",
                                            {
                    ...
                    <div className="w-full">
                      {wishlistInfos.length !== 0 && (
                        <div className="p-6 bg-gradient-to-br from-white to-amber-50 rounded-xl shadow-md border-2 border-amber-100">
                          ...
                          <div className="flex gap-6 overflow-y-auto custom-scrollbar">
                            {wishlistInfos.map((wishlist) => (
                              <div
                                key={wishlist.id}
                                className="group mb-6 w-[200px] min-h-[160px] bg-gradient-to-br from-amber-50 to-amber-100 rounded-xl shadow-md hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 cursor-pointer p-5 relative overflow-hidden border-2 border-amber-100 hover:border-amber-200"
                              >
                                {/* Decorative corner accent */}
                                <div className="absolute top-0 right-0 w-0 h-0 border-l-[40px] border-l-transparent border-t-[40px] border-t-amber-300/30"></div>
                                ...
                                <div className="w-full h-full flex flex-col justify-center">
                                  <div className="text-center relative z-10">
                                    ...
                                    {/* Author with decorative underline */}
                                    {wishlist.author && (
                                      <p className="text-sm text-amber-700 italic relative inline-block">
                                        {wishlist.author}
                                        <span className="absolute bottom-0 left-0 w-full h-0.5 bg-gradient-to-r from-amber-300 to-amber-200"></span>
                                      </p>
                                    )}
                                  </div>
                                </div>
